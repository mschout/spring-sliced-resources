...
public class WebTestUtils {
	...
	/**
	 * Initializes web tests. Will register a {@link MockHttpServletRequest} for the current
	 * thread.
	 */
	...
	/**
	 * Initializes web tests for the given {@link HttpServletRequest} which will registered
